...
public class PropertiesObject {
    ...
    @JsonProperty(SERIALIZED_NAME_TAGS)
    @Json(name = SERIALIZED_NAME_TAGS)
    private Map<String, Object> tags = null;

    public static final String SERIALIZED_NAME_LANGUAGE = "language";
    @JsonProperty(SERIALIZED_NAME_LANGUAGE)
    @Json(name = SERIALIZED_NAME_LANGUAGE)
    private String language;

    public static final String SERIALIZED_NAME_TIMEZONE_ID = "timezone_id";
    @JsonProperty(SERIALIZED_NAME_TIMEZONE_ID)
    @Json(name = SERIALIZED_NAME_TIMEZONE_ID)
    private String timezoneId;

    public static final String SERIALIZED_NAME_LAT = "lat";
    @JsonProperty(SERIALIZED_NAME_LAT)
    @Json(name = SERIALIZED_NAME_LAT)
    private BigDecimal lat;

    public static final String SERIALIZED_NAME_LONG = "long";
    @JsonProperty(SERIALIZED_NAME_LONG)
    @Json(name = SERIALIZED_NAME_LONG)
    private BigDecimal _long;

    public static final String SERIALIZED_NAME_COUNTRY = "country";
    @JsonProperty(SERIALIZED_NAME_COUNTRY)
    @Json(name = SERIALIZED_NAME_COUNTRY)
    private String country;

    public static final String SERIALIZED_NAME_FIRST_ACTIVE = "first_active";
    @JsonProperty(SERIALIZED_NAME_FIRST_ACTIVE)
    @Json(name = SERIALIZED_NAME_FIRST_ACTIVE)
    private BigDecimal firstActive;

    public static final String SERIALIZED_NAME_LAST_ACTIVE = "last_active";
    @JsonProperty(SERIALIZED_NAME_LAST_ACTIVE)
    @Json(name = SERIALIZED_NAME_LAST_ACTIVE)
    private BigDecimal lastActive;

    public static final String SERIALIZED_NAME_AMOUNT_SPENT = "amount_spent";
    @JsonProperty(SERIALIZED_NAME_AMOUNT_SPENT)
    @Json(name = SERIALIZED_NAME_AMOUNT_SPENT)
    private BigDecimal amountSpent;

    public static final String SERIALIZED_NAME_PURCHASES = "purchases";
    @JsonProperty(SERIALIZED_NAME_PURCHASES)
    @Json(name = SERIALIZED_NAME_PURCHASES)
    private List<Purchase> purchases = null;

    public static final String SERIALIZED_NAME_IP = "ip";
    @JsonProperty(SERIALIZED_NAME_IP)
    @Json(name = SERIALIZED_NAME_IP)
    private String ip;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(tags, language, timezoneId, lat, _long, country, firstActive, lastActive, amountSpent,
            purchases, ip);
    }
