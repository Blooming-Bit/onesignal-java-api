...
public class SubscriptionObject {
    ...
    @JsonProperty(SERIALIZED_NAME_APP_ID)
    @Json(name = SERIALIZED_NAME_APP_ID)
    ...
    public enum TypeEnum {
        ...
        public static class Adapter {
            @ToJson
            public String toJson(TypeEnum typeEnum) {
                return typeEnum.getValue();
            }

            @FromJson
            public TypeEnum fromJson(String value) {
    ...
    @JsonProperty(SERIALIZED_NAME_TOKEN)
    @Json(name = SERIALIZED_NAME_TOKEN)
    private String token;

    public static final String SERIALIZED_NAME_ENABLED = "enabled";
    @JsonProperty(SERIALIZED_NAME_ENABLED)
    @Json(name = SERIALIZED_NAME_ENABLED)
    private Boolean enabled;

    public static final String SERIALIZED_NAME_NOTIFICATION_TYPES = "notification_types";
    @JsonProperty(SERIALIZED_NAME_NOTIFICATION_TYPES)
    @Json(name = SERIALIZED_NAME_NOTIFICATION_TYPES)
    private BigDecimal notificationTypes;

    public static final String SERIALIZED_NAME_SESSION_TIME = "session_time";
    @JsonProperty(SERIALIZED_NAME_SESSION_TIME)
    @Json(name = SERIALIZED_NAME_SESSION_TIME)
    private BigDecimal sessionTime;

    public static final String SERIALIZED_NAME_SESSION_COUNT = "session_count";
    @JsonProperty(SERIALIZED_NAME_SESSION_COUNT)
    @Json(name = SERIALIZED_NAME_SESSION_COUNT)
    private BigDecimal sessionCount;

    public static final String SERIALIZED_NAME_SDK = "sdk";
    @JsonProperty(SERIALIZED_NAME_SDK)
    @Json(name = SERIALIZED_NAME_SDK)
    private String sdk;

    public static final String SERIALIZED_NAME_DEVICE_MODEL = "device_model";
    @JsonProperty(SERIALIZED_NAME_DEVICE_MODEL)
    @Json(name = SERIALIZED_NAME_DEVICE_MODEL)
    private String deviceModel;

    public static final String SERIALIZED_NAME_DEVICE_OS = "device_os";
    @JsonProperty(SERIALIZED_NAME_DEVICE_OS)
    @Json(name = SERIALIZED_NAME_DEVICE_OS)
    private String deviceOs;

    public static final String SERIALIZED_NAME_ROOTED = "rooted";
    @JsonProperty(SERIALIZED_NAME_ROOTED)
    @Json(name = SERIALIZED_NAME_ROOTED)
    private Boolean rooted;

    public static final String SERIALIZED_NAME_TEST_TYPE = "test_type";
    @JsonProperty(SERIALIZED_NAME_TEST_TYPE)
    @Json(name = SERIALIZED_NAME_TEST_TYPE)
    private BigDecimal testType;

    public static final String SERIALIZED_NAME_APP_VERSION = "app_version";
    @JsonProperty(SERIALIZED_NAME_APP_VERSION)
    @Json(name = SERIALIZED_NAME_APP_VERSION)
    private String appVersion;

    public static final String SERIALIZED_NAME_NET_TYPE = "net_type";
    @JsonProperty(SERIALIZED_NAME_NET_TYPE)
    @Json(name = SERIALIZED_NAME_NET_TYPE)
    private BigDecimal netType;

    public static final String SERIALIZED_NAME_CARRIER = "carrier";
    @JsonProperty(SERIALIZED_NAME_CARRIER)
    @Json(name = SERIALIZED_NAME_CARRIER)
    private String carrier;

    public static final String SERIALIZED_NAME_WEB_AUTH = "web_auth";
    @JsonProperty(SERIALIZED_NAME_WEB_AUTH)
    @Json(name = SERIALIZED_NAME_WEB_AUTH)
    private String webAuth;

    public static final String SERIALIZED_NAME_WEB_P256 = "web_p256";
    @JsonProperty(SERIALIZED_NAME_WEB_P256)
    @Json(name = SERIALIZED_NAME_WEB_P256)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, subscriptionObject.id) &&
            Objects.equals(this.appId, subscriptionObject.appId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, appId, type, token, enabled, notificationTypes, sessionTime, sessionCount, sdk, deviceModel,
            deviceOs, rooted, testType, appVersion, netType, carrier, webAuth, webP256);
    }
